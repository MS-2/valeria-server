...
var control = _interopRequireWildcard(require("../controllers/companycontroller.js"));

var _middlewares = require("../middlewares");

var router = (0, _express.Router)();
router.post('/', [_middlewares.verifyToken, _middlewares.isAdmin], control.createCompany);
